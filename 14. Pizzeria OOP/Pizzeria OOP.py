...
class Pizza:
    ...
    "pickled cucumber","tabasco","sun-dried tomatoes","paprika","parmesan","mozzarella","basil","arugula","oregano"]
...
Capricciosa=Pizza("Capricciosa", (Pizza.ingredients[0],Pizza.ingredients[1],Pizza.ingredients[2]), Pizza.size[0], 20)
